...
foreach ($view->users as $user)
{
    if ($user->getTypeLoginUser() != 1)
    {
        ...
        echo '<td><a href="' . $view->url(array('module' => null, 'controller' => 'Dashboard', 'action' => 'viewProfile', 'user' => $user->getId())) . '" ><img src="'.$view->getBaseUrl().'/images/iconos/magnify.png" alt="Profile" title="View Profile"/></a></td>';
