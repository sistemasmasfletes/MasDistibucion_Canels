    ...
    <div class="row" >
        <div class="span12 blockGray">
            <div class="blockInner">
                ...
                <form method="post" >
                    Repetir cada semana &nbsp; &nbsp;
                    <input type="checkbox" name="week" id="week" /><br/><br/>
                    Repetir el: &nbsp; &nbsp;
                    <input type="checkbox" name="lu" id="lu"/> Lu &nbsp;
                    <input type="checkbox" name="ma" id="ma"/> Ma &nbsp;
                    <input type="checkbox" name="mi" id="mi"/> Mi &nbsp;
                    <input type="checkbox" name="ju" id="ju"/> Ju &nbsp;
                    <input type="checkbox" name="vi" id="vi"/> Vi &nbsp;
                    <input type="checkbox" name="sa" id="sa"/> Sa &nbsp;
                    <input type="checkbox" name="do" id="do"/> Do <br/><br/>
