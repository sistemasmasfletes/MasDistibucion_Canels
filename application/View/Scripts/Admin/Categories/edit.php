<div class="contiene-bread">
    ...
    <li class="active actualpg ">Editar Categoría</li>
</ol>
</div>
<div class="container">
    <div class="row" >
...
//                $view->sc->generateForm();?>
                <form method="post"   enctype="multipart/form-data">
                    ...
                    <input type="text" class="" id="name" name="name" required="required" value="<?php echo $view->category[0]->getName();?>"/>
                    <input type="hidden" class="" id="imagePath" name="imagePath"  >
                    </div>
                    <div class="col-md-3">
                        <input type="file" name="fileToUpload" id="filechooser" accept="image/png" onchange="uploadFile(this.value)" value="<?php echo  $view->getBaseUrl().'/'.$view->category[0]->getImagePath();?>">
                        <img src="<?php echo  $view->getBaseUrl().'/'.$view->category[0]->getImagePath();?>">
                    </div>
                    <br>
