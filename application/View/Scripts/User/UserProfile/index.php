<div class="contiene-bread">
    <ol class="breadcrumb">
        ...
        <li class="active actualpg ">Datos de Usuario del Sistema</li>
    </ol>
</div>
<div class="container">
    <div class="row" >
        ...
        <div class="blockInner">
            ...
            if ($view->resp === true) {
                ...
                echo 'Tu perfil a sido modificado correctamente';
                echo '</div>';
            ...
            ?>
            <span style="font-size:1.5em; font-weight:bold">Perfil: estos son los datos de contacto que aparecer&aacute;n en las Ordenes</span>
                ...
                <form id="formProfileUser" method="post">
                    <table>
                        <div class="">
                            <tr>
                                <th>Nombre:</th>
                                <td><input style="color:#000;" type="text" id="firstName" name="firstName" value="<?php echo $view->user->getFirstName(); ?>"/></td>
                                <td></td>
                            </tr>
                            <tr>
                                <th>Apellido:</th>
                                <td><input style="color:#000;" type="text" id="lastName" name="lastName" value="<?php echo $view->user->getLastName(); ?>"/></td>
                                <td></td>
                            </tr>
                            <tr>
                                <th>Titulo:</th>
                                <td><input type="text" id="title" name="title" value="<?php echo $view->user->getTitle() != "" ? $view->user->getTitle() : ""; ?>"/></td>
                                <td></td>
                            </tr>
                            <!-- tr>
                                <th>Nombre Comercial:</th>
                                <td><input type="text" id="commercialName" name="commercialName" value="<?php //echo $view->user->getCommercialName() != "" ? $view->user->getCommercialName() : ""; ?>"/></td>
                                <td></td>
                            </tr-->
                            <!-- tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" style="color:#000;" id="cellPhone" name="cellPhone" value="<?php echo $view->user->getCellPhone(); ?>"/></td>
                                <td></td>
                            </tr>
                            <tr>
                                <th>N&uacute;mero local:</th>
                                <td><input type="text" id="localNumber" name="localNumber" value="<?php echo $view->user->getLocalNumber(); ?>"/></td>
                                <td></td>
                            </tr>
                        </div>
                        <!-- div class="">
