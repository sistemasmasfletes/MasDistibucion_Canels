 ...
 */
class DefaultDb_Entities_State extends \DefaultDb_Entities_State implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'abbreviation', 'estatus', 'country');
    }
