 ...
 */
class DefaultDb_Entities_TipoMovimientos extends \DefaultDb_Entities_TipoMovimientos implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'tipoMovimiento','client');
    }
