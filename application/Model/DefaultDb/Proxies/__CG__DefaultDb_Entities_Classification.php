 ...
 */
class DefaultDb_Entities_Classification extends \DefaultDb_Entities_Classification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'size', 'activity', 'consumption');
    }
