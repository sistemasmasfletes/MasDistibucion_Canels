 ...
 */
class DefaultDb_Entities_TipoMonedas extends \DefaultDb_Entities_TipoMonedas implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'moneda', 'client', 'timestamp', 'currencyCode');
    }
