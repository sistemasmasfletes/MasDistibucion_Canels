 ...
 */
class DefaultDb_Entities_Category extends \DefaultDb_Entities_Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setCategoryFather($categoryFather);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'imagePath', 'categoryFather', 'users');
    }
