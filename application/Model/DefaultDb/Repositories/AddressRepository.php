...
class DefaultDb_Repositories_AddressRepository extends EntityRepository
{
    ...
    public function getAdditionalInformationListDQL($page,$rowsPerPage,$sortField,$sortDir, $sidx, $userId, $Pais, $Estado, $Ciudad, $Calle, $CP, $srch){
