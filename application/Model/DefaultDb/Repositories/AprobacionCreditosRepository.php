...
//    
//    public function getAprobacionCreditosListDQL($page,$rowsPerPage,$sortField,$sortDir,$id,$cliente,$tipoPago,$montoCompra,$creditos,$fecha,$nombreImg,$path,$moneda,$name,$referencia,$cuenta,$estado){
