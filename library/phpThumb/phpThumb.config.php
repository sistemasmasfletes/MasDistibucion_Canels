...
define('DESARROLLO',1);
if(DESARROLLO == 1)
	$path = 'c:\\xampp\\htdocs\\mn\\public';
else
	$path = 'c:\\xampp\\htdocs\\multinivel\\public';
...
$PHPTHUMB_CONFIG['error_message_image_default'] = '/images/ui/no_pic.jpg';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
