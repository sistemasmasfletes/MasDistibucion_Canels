...
$config =  $config = parse_ini_file('../../../application/Config/server.ini', true);
$url = $config['server']['protocol'].'://'.$config['server']['host'].'/';
$PHPTHUMB_CONFIG['error_message_image_default'] = $url.'images/ui/no_pic.jpg';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
