function PagosDataService(DataService,PATH){
    var data=[];
    ...
    this.getCompraCreditos=function(paramsData){
        ...
        return DataService.get(PATH.pagos +'/getCompraCreditos',params,null);
    }

    

    this.getPagosByName = function(params){
        if(!params) params={};
        return DataService.get(PATH.pagos + '/getPagosCatalog',params,null);
    }
}