function ReportIndexController($rootScope,$scope,$timeout,$state,$stateParams,ngTableParams,ModalService,ReportDataService,UtilsService,CONFIG){
    ...
    $scope.tableParams = new ngTableParams(
        ...
        },
        {
            ...
            getData:function($defer,params){
                ...
                ReportDataService.getReport(postParams)
