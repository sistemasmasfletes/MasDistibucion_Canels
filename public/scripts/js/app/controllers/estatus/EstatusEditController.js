function EstatusEditController($scope,$timeout,$state,$stateParams,PATH,PARTIALPATH,ModalService,CatalogService,EstatusDataService,estatus,$http){
    $scope.estado=estatus;
    $scope.estatusStatus=CatalogService.getEstatusStatus(); //definir en CatalogService
    $scope.estatusTypes=CatalogService.getEstatusType();
    ...
    $scope.verificarExistencia = function() {
        ...
        var url = PATH.estatus + '/fncVerificar';
    ...
    $scope.successVerificar = function(data) {
        ...
        else
        {
            ...
            {
                EstatusDataService.save($scope.estado, {})
                .success( onSave )
