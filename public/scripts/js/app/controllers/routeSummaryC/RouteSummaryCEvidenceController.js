...
function RouteSummaryCEvidenceController($rootScope,$scope,$timeout,$state,$stateParams,ngTableParams,ModalService,RouteSummaryDataService,UtilsService,CONFIG){
