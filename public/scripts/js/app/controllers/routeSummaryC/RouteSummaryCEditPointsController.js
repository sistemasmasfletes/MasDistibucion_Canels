...
function RouteSummaryCEditPointsController($scope,$timeout,$state,$stateParams,ngTableParams,PARTIALPATH,ModalService,MessageBox,CatalogService,RouteSummaryDataService,routeSummary,CONFIG,routePointActivity){
