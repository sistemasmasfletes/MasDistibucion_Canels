...
function RouteSummaryCIndexController($rootScope, $scope, $timeout, $state, $stateParams, ngTableParams, PARTIALPATH, ModalService,MessageBox, RouteSummaryDataService, UtilsService, CONFIG) {
    $scope.Quagga = {};
    $scope.grid = {};
