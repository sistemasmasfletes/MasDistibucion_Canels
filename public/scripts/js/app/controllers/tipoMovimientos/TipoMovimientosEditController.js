function TipoMovimientosEditController($scope,$timeout,$state,$stateParams,PATH, PARTIALPATH,ModalService,CatalogService,TipoMovimientosDataService,tipoMovimientos, $http){
    $scope.movimiento=tipoMovimientos;
    $scope.tipoMovimientosStatus=CatalogService.getTipoMovimientosStatus(); //definir en CatalogService
    $scope.tipoMovimientosTypes=CatalogService.getTipoMovimientosType();
    ...
    $scope.verificarExistencia = function() {
        ...
        var data = {tipoMovimiento: $scope.movimiento};
        var url = PATH.tipoMovimientos + '/fncVerificar';
    ...
    $scope.successVerificar = function(data) {
        ...
        else
        {
            ...
            {
                TipoMovimientosDataService.save($scope.movimiento, {})
                .success( onSave )
