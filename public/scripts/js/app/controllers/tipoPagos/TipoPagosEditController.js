function TipoPagosEditController($scope,$timeout,$state,$stateParams,PATH, PARTIALPATH,ModalService,CatalogService,TipoPagosDataService,tipoPagos, $http){
    $scope.tipo=tipoPagos;
    $scope.tipoStatus=CatalogService.getTipoPagosStatus(); //definir en CatalogService
    $scope.tipoTypes=CatalogService.getTipoPagosType();
    ...
    $scope.verificarExistencia = function() {
        ...
        var data = {tipoPago: $scope.tipo};
        var url = PATH.tipoPagos + 'fncVerificar';
    ...
    $scope.successVerificar = function(data) {
        ...
        else
        {
            ...
            {
                TipoPagosDataService.save($scope.tipo, {})
                .success( onSave )
