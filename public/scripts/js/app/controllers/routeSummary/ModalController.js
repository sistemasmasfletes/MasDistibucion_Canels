...
function ModalController($rootScope, $scope, $timeout, $state, $stateParams, ngTableParams, PARTIALPATH, ModalService, RouteSummaryDataService, UtilsService, CONFIG) {
    var barcode = "";
    var comp = false;
            ...
            },
    {
        ...
        getData: function ($defer, params) {
            ...
            RouteSummaryDataService.getRouteSummaryPoints(postParams)
                    .then(function (response) {
                        ...
                        if (data.data[0].HoraActual != null) {
                            var modalOptions3 = {
                            ...
                            RouteSummaryDataService.saveEndHourRoute($stateParams);
    ...
    $scope.go = function (schedule) { //Pantalla ver actividad
        ...
        if ($activity >= 1) {
            $state.go('routeSummary.activity', {id2: $scheduleRouteId, id: $routePoint_id});
        }
        else {
            var modalOptions = {
                actionButtonText: 'Aceptar',
