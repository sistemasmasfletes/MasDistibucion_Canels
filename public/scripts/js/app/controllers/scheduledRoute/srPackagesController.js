function srPackagesController($scope,$timeout,$state,$stateParams,ngTableParams,ModalService,ActivityReportDataService,UtilsService,CONFIG){
    ...
    $scope.tableParams = new ngTableParams(
        ...
        },
        {
            ...
            getData:function($defer,params){
                ...
                ActivityReportDataService.getPackageTracking(postParams)
    ...
    $scope.customFilter = [
        ...
        {name:'packageName',type:'text',label:'Paquete'}
    ]
