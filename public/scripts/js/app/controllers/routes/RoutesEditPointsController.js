function RoutesEditPointsController($scope,$cookieStore,$timeout,$state,$stateParams,$compile,PATH,PARTIALPATH,ModalService, JQGridService,CatalogService,RoutesDataService,PointsDataService,points){
    ...
    colNames: ["Maps","Orden","id","route_id","Punto de venta", "Tipo","Dirección","pointType", "Minutos", "Segundos" ,"Estatus","Requerido","nombre"/*,"url"*/],
    colModel: [
        {name: "url", index: "url", width: 20, editable: false, sortable:false, edittype: "custom",
        	formatter:getUrlrer
        },
        {name: "order_number", index:"order_number", width: 20, align: "center", editable: false, sortable:false},
        ...
        {name: "point_id", index: "point_id", width: 80, editable: true, sortable:false, edittype: "custom",
        ...
        {name: "direccion", index:"direccion", width: 120, align: "center", editable: false, sortable:false},
        {name: "pointType", index: "pointType", width: 0, editable: true, sortable:false, hidden:true},
        {name: "arrival_min", index: "arrival_min", width: 20, align: "center", editable: true, sortable:false, edittype: "custom", 
        ...
        {name: "arrival_seg", index: "arrival_seg", width: 20, align: "center", editable: true, sortable:false, edittype: "custom", 
        ...
        {name: "status", index: "status", width: 50, editable: true, align: "center", sortable:false, edittype: "custom",
        ...
        {name: "required", index: "required", width: 50, editable: true, align: "center", sortable:false, edittype: "custom",
        ...
        //{name: "url", index: "url", width: 50, editable: true, sortable:false,hidden:true}
    ...
    $scope.grdPoints.edit.mapsUrl = function(){////MOSTRAR MAPS DEL PUNTO(09-04-20 EAAL)////////// 
        var currentRow = $scope.grdPoints.apicall('getRowData', $scope.grdPoints.edit.selRow);
        if (currentRow.id){
        	//alert(currentRow.url)
        	window.open(currentRow.url)
        }else {}
    }
    ...
    function getUrlrer(value, options){
    	if(value == null){
    		markup ='';
        }else{
        	var markup = '<a id="pointurl" name="pointurl" href="'+value+'" target="_blank"><span class="pers-btn icono-posicion tam-normal"></span></a>'; 
    	}
        return markup;
    }
