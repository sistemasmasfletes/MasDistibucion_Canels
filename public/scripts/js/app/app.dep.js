...
//            actividadesChofer: context.path + '/OperationController/ActividadesChofer',
            ...
            paypalCancel: 'https://desarrollo.gservicio.com/MasDistribucion/application/Controller/OperationController/PaypalCancelController.php',

            paypalSuccess: 'https://desarrollo.gservicio.com/MasDistribucion/application/Controller/OperationController/PaypalSuccessController.php',
            ...
            contracts:context.path + '/OperationController/Contracts/',/************************************MODULO DE CONTRATOS CLIENTE*************************************/
            ...
            promotionSchedule:context.path + '/User/PromotionSchedule/',
            promotionReceived:context.path + '/User/PromotionReceived/'
    ...
    .constant(
        ...
        'PARTIALPATH',{
            ...
            modalMove: context.path + context.pathJs + 'partials/modalMove.html',/**MODAL PARA CAMBIAR POSICION DE PUNTOS EN LA RUTA EAAL**/
...
//            actividadesChofer:context.path + context.pathJs + 'partials/actividadesChofer/',
            ...
            contracts:context.path + context.pathJs + 'partials/contracts/',/************************************MODULO DE CONTRATOS CLIENTE*************************************/
            ...
            promotionSchedule: context.path + context.pathJs + 'partials/promotionSchedule/',
            promotionReceived: context.path + context.pathJs + 'partials/promotionReceived/'
        }
    ...
    .service('ContractDataService',['DataService','PATH',ContractDataService])/************************************MODULO DE CONTRATOS CLIENTE*************************************/
...
//    .service('ActividadesChoferDataService',['DataService','PATH',ActividadesChoferDataService])
    ...
    .service('PromotionScheduleDataService',['DataService','PATH',PromotionScheduleDataService])
    .service('PromotionReceivedDataService',['DataService','PATH',PromotionReceivedDataService])
    ...
    .directive('zdRating', ['$modal','PARTIALPATH',ZdRating])
